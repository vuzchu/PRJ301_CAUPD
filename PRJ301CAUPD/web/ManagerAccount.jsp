<%-- 
    ...
    Created on : Mar 6, 2023, 9:42:59 AM
    Author     : vu
--%>
                        ...
                        <tbody>
                            <c:forEach items="${account}" var="a">
                                <tr>
                                    ...
                                    <td>${a.user}</td>                            
                                    <td>${a.pass}</td>
                                    <td>${a.isSell}</td><!-- comment -->
                                    <td>${a.isAdmin}</td>
                                    <td>
                                        <a href="edit?uid=${a.uid}"  class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                        <a href="deletea?uid=${a.uid}" class="delete"
                    ...
                    <div class="modal-content">
                        <form action="adda" method="post">
                            ...
                            <div class="modal-body">	                              
                                ...
                                <div class="form-group">
                                    <label>pass</label>
                                    <textarea name="pass" class="form-control" required></textarea>
                                </div>
                                <div class="form-group">
                                    <label>isSell</label>
                    ...
                    <div class="modal-content">
                        <form>
                            ...
                            <div class="modal-body">					
                                ...
                                <div class="form-group">
                                    <label>Price</label>
                                    <input type="text" name="price" class="form-control" required value="${param.price}">
                                </div>
                                <div class="form-group">
                                    <label>Image</label>
